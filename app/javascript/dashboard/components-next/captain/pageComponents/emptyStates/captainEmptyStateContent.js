...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Fluxo Ti',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Fluxo Ti.',
    created_at: 1736143273,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Fluxo Ti',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Fluxo Ti',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Fluxo Ti',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Fluxo Ti.',
    created_at: 1736143276,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | Fluxo Ti',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    id: 3064,
    name: 'Financial Reporting | User Guide | Fluxo Ti',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Fluxo Ti deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Fluxo Ti' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Fluxo Ti?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Fluxo Ti' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Fluxo Ti?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Fluxo Ti' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Fluxo Ti?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Fluxo Ti' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Fluxo Ti?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Fluxo Ti' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Fluxo Ti allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Fluxo Ti?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Fluxo Ti' },
