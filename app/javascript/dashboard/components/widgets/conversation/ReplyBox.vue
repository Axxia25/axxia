  ...
  methods: {
    ...
    confirmOnSendReply() {
      ...
      if (!this.showMentions) {
        ...
        // Although Fluxo Ti combines these into a single message, Instagram sends separate echo events for each component.
        // This can create duplicate messages in Fluxo Ti. To prevent this issue, we'll handle text and attachments as separate messages.
