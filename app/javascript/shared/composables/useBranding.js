...
export function useBranding() {
  ...
  /**
   * Replaces "Fluxo Ti" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "Fluxo Ti" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/Fluxo Ti/g, installationName);
  };
